...
const ToolsAccessories = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/ItemCategoryMainID=CTM_0018`,
        {
          headers: {
            APIKey: process.env.REACT_APP_API_KEY,
          },
  ...
  return (
    <div className="w-full pt-20 font-karla">
      <div className="w-full lg:h-[350px] relative">
        <img
          src="https://www.shutterstock.com/image-photo/all-tools-supplies-home-construction-600nw-1964203402.jpg"
                  ...
                  .map((subCategory) => (
                    <div key={subCategory.categorySubID} className="flex gap-2">
                      <input
                        ...
                        id="subCat"
                        checked={
                          selectedSubCategory === subCategory.categorySubID
                        }
                        onChange={() =>
                ...
                <div className="w-full lg:h-[250px] xl:h-[340px] border border-black cursor-pointer relative">
                  <Link to={`/product/${item.itemID}`}>
                    <img
                      ...
                      className="w-full lg:h-[220px] xl:h-[310px] object-contain p-3"
                      alt=""
                    />
