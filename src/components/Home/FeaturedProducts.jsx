    ...
    <div className='w-full min-h-[350px] mt-10 md:mt-0 pb-10'>
        ...
        <div className='flex items-center justify-center w-full h-full mt-5'>
            <input type="text"
                ...
                placeholder='Search' className='w-[80%] sm:w-[500px] h-[40px] pl-3 border outline-none' /> 
            <button type='submit' onClick={() => handleSearch()} className='w-[40px] h-[40px] flex items-center justify-center bg-gray-200 text-gray-700 font-karla'><FaSearch /></button>
        </div>
