  ...
  return (
    <div className="w-full md:h-screen pt-20 relative">
      ...
      <div className="w-full md:h-[82.5%] mt-20 flex flex-col items-center justify-center text-center absolute inset-0 font-karla">
        <h1 className="w-[90%] mx-auto md:w-full text-4xl md:text-6xl lg:text-8xl text-white font-bold uppercase">
          Ronix Power Tools
        </h1>
        <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#bf0000] mt-2 font-light">
